...
export default function FlipCard({
  card, playerName, isWinner, canPick, showName, delay = 0, onClick,
}) {
  ...
  return (
    <div className="card-flip-container" style={{ animationDelay: `${delay}ms` }}>
      <div className={`card-flip-inner ${flipped ? "flipped" : ""}`} style={{ minHeight: "120px" }}>
